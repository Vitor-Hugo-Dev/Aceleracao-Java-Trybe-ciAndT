...
public class Viagem {
  ...
  public String retornarInformacaoViagem() {
    ...
    String tempoEmbarque = tempoViagem.retonarDesembarqueHorarioLocalDestino();
    String tempoDesembarque = tempoViagem.retonarDesembarqueHorarioLocalDestino();

    return voo.retornarInformacaoVoo(tempoEmbarque, origem, tempoDesembarque, destino);
  }
}
