          ...
          if (op == 1) {
            ...
            do {
              System.out.printf("Entre com o número (1-%d) para a conta\nque "
                  + "o extrato será impresso: ", pessoaClienteAutenticada.retornarNumeroDeContas());
              conta = sc.nextInt() - 1;
            ...
            do {
              System.out.printf("Entre o número (1-%d) para selecionar a conta para "
                  + "o saque: ", pessoaClienteAutenticada.retornarNumeroDeContas());
            ...
            do {
              System.out.printf(
                  "Entre com a quantia a ser sacada (máximo R$%.02f): R$ ", saldoConta);
            ...
            do {
              System.out.printf("Entre com o número (1-%d) para selecionar a conta para "
                  + "depósito: ", pessoaClienteAutenticada.retornarNumeroDeContas());
              paraConta = sc.nextInt() - 1;

              if (paraConta < 0 || paraConta >= pessoaClienteAutenticada.retornarNumeroDeContas()) {
                System.out.println("Índice de conta inválido, tente novamente.");
            ...
            do {
               ...
               */
              System.out.printf(
                  "Entre com a quantia para ser transferida (máximo R$%.02f): R$ ", saldoConta);
              quantia = sc.nextDouble();
